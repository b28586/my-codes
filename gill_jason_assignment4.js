...
var smallValue = function(numArray, number) {
        ...
        for (i = 0; i < numArray.length; i++) {
                if (numArray[i] > number) {
                        largNums.push(numArray[i]);
                }
        }
        
        smallNum = largNums[0];
        
        for (j = 0; j < largNums.length; j++) {
                if (smallNum > largNums[j]) {
                        smallNum = largNums[j];
                }
        }
...
var specificDec = function (number) {
        ...
        return (number + " has been rounded to " + newNum);        
}
...
console.log(emailCheck("thewiccan@fullsail.edu"));
console.log(emailCheck("thewiccan@fullsailedu"));

console.log(numberCheck("701-521-8767"));
console.log(numberCheck("(912)-265-9786"));
console.log(numberCheck("502-125-564"));
